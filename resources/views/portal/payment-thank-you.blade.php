        ...
        <div class="col-lg-7 col-md-9">
            <div class="card border-0 shadow-sm pay-card">
                <div class="card-body text-center p-5">
                    <div class="mx-auto mb-4 pay-status-disc">
                        <i class="bi bi-check-lg pay-status-icon"></i>
                    </div>

                    <h2 class="fw-bold mb-2 pay-heading">Payment Successful</h2>
                    <p class="text-muted mb-4 pay-subtext">
                        Thank you{{ optional($trip->user)->full_name ? ', ' . $trip->user->full_name : '' }} — your payment has been received and your booking is confirmed.
                    </p>

                    <div class="border rounded-3 p-3 mb-4 text-start pay-summary">
                        <div class="row small">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                        <a href="{{ route('trip.detail', $trip->id) }}" class="btn btn-success btn-lg px-4 pay-cta-btn">
