            ...
            <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                <div class="card-body text-center p-5">
                    <div class="mx-auto mb-4 d-flex align-items-center justify-content-center"
                         style="width:88px; height:88px; border-radius:50%; background: linear-gradient(135deg, var(--heco-primary-500, #7ca4a3) 0%, var(--heco-primary-700, #79a09f) 100%); color:#fff;">
                        <i class="bi bi-check-lg" style="font-size:48px; line-height:1;"></i>
                    </div>

                    <h2 class="fw-bold mb-2" style="color: var(--heco-primary-800, #496767);">Payment Successful</h2>
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
                        <a href="{{ route('trip.detail', $trip->id) }}" class="btn btn-success btn-lg px-4" style="background: linear-gradient(135deg, var(--heco-primary-600, #7aa1a0) 0%, var(--heco-primary-700, #79a09f) 100%); border: 0;">
